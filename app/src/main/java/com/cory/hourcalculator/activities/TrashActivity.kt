...
class TrashActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when {
            accentColor.loadAccent() == 0 -> {
                floatingActionButtonTrash.backgroundTintList = ColorStateList.valueOf(Color.rgb(38, 166, 154))

            }
            accentColor.loadAccent() == 1 -> {
                floatingActionButtonTrash.backgroundTintList = ColorStateList.valueOf(Color.rgb(252, 126, 189))
            }
            accentColor.loadAccent() == 2 -> {
                floatingActionButtonTrash.backgroundTintList = ColorStateList.valueOf(Color.rgb(255, 153, 0))
            }
            accentColor.loadAccent() == 3 -> {
                floatingActionButtonTrash.backgroundTintList = ColorStateList.valueOf(Color.rgb(229, 57, 53))
            }
        }
